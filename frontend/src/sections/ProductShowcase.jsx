    ...
    <section className="bg-gradient-to-t from-[#FFFFFF] via-[#D2DCFF] to-[#FFFFFF] py-16 sm:py-24">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="max-w-[640px] mx-auto flex flex-col items-center">
          <Link to={"/search"} className="text-sm inline-flex border border-[#222]/10 px-3 py-1 rounded-lg tracking-tight mb-6">
            Boost your Grade
          </Link>
          ...
          <Link 
          to={"/search"}
          className="bg-black text-white px-6 py-2 rounded-lg font-medium tracking-tight transition-colors hover:bg-black/90">
            Get for free
          </Link>
        </div>
      </div>
